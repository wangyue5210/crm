                ...
                $.ajax({
                    ...
                    * */
                        ...
                        if (data.success) {
                            ...
                            //刷新列表
                            //pageList(1,2);
                            //第一个参数表示操作后停留在当前页，第二个参数维持每页的记录数
    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">创建市场活动</h4>
            </div>
...
<!-- copy!!!!!!!创建市场活动的模态窗口，上面的起作用 -->
<div class="modal fade" id="8888createActivityModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
